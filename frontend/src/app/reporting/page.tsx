...
import { MonthlyReportWizard } from "@/components/reporting/MonthlyReportWizard";
...
export default function ReportingPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Header
        title="Reporting"
        subtitle={activeTab === "weekly" ? "Weekly KPI Section Generator" : "Monthly Report Generator"}
        onRefresh={activeTab === "weekly" && result ? handleGenerate : undefined}
